USE test_db;
CREATE TABLE IF NOT EXISTS user (user_id INT NOT NULL AUTO_INCREMENT, username varchar(255) NOT NULL, password varchar(255) NOT NULL, permission_level ENUM('admin', 'user'),PRIMARY KEY (user_id));
CREATE TABLE IF NOT EXISTS resource (resource_id INT NOT NULL AUTO_INCREMENT, name varchar(255), description varchar(255), max_users INT,PRIMARY KEY (resource_id));
