...
exports.buildQueryForIncludedTags = function(includedTags, start_time, end_time, group_ids) {
    ...
    return squel.select()
        ...
        .field("reservation.reservation_title")
        .field("reservation.reservation_description")
        .field("reservation_resource.is_confirmed")
        .field("user.username")
        ...
        .left_join("reservation", null, "reservation.start_time <= " + end_time + " AND reservation.end_time >= " + start_time)
        .left_join("reservation_resource", null, "reservation.reservation_id = reservation_resource.reservation_id AND resource.resource_id = reservation_resource.resource_id")
